...
const findUsersByAlarmUuid = async (alarmUuid) => {
    ...
    const query = `
        SELECT users_alarms.uuid as user_alarm_uuid, users_alarms.alarm_uuid, users_alarms.user_uuid, users_alarms.business_uuid,
        users.first_name, users.last_name, users.dni, users.email, users.phone 
